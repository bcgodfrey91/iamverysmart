export default [
  {
    body: 'A static site that provides various personal project and take home challenge ideas.',
    styleClass: 'perpro',
  ...
  {
    body: 'An app that allows users to create an account and save notes-to-self.',
  ...
  },
  {
    ...
    styleClass: 'amptron',
    technologies: 'Electron, Vue, Node.js, HTML5 Audio',
    title: 'Amptron',
