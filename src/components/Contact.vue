  ...
  <app-section :styleClass="{ styleClass }">
    ...
    <div class="contact-icon-container">
      <a class="icon-link" href="https://github.com/bcgodfrey91" target="_blank">
        <svg class="icon github" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 2 24 24">
          <title>github</title>
      ...
      <a class="icon-link" href="https://www.linkedin.com/in/benjamin-godfrey/" target="_blank">
        <svg class="icon linkedin" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 2 24 24">
      ...
      <a class="icon-link" href="https://twitter.com/BenTheHuman" target="_blank">
        <svg class="icon twitter" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 2 24 24">
          <title>twitter</title>
      ...
      <a class="icon-link" href="mailto:bcgodfrey91@gmail.com">
        <svg class="icon email" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="3 3 22 23">
