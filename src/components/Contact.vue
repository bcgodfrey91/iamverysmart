  ...
  <app-section :styleClass="{ styleClass }">
    ...
    <div class="contact-icon-container">
      <a class="icon-link" href="https://github.com/bcgodfrey91" target="_blank">
        <svg class="icon github" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 28">
          <title>github</title>
      ...
      <a class="icon-link" href="https://www.linkedin.com/in/benjamin-godfrey/" target="_blank">
        <svg class="icon linkedin" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 28">
      ...
      <a class="icon-link" href="https://twitter.com/BenTheHuman" target="_blank">
        <svg class="icon twitter" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 28">
          <title>twitter</title>
      ...
      <a class="icon-link" href="mailto:bcgodfrey91@gmail.com" target="_blank">
        <svg class="icon email" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28">
